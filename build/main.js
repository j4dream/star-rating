...
var defaults={size:'30px',preColor:'#aaa',selectColor:'orange',count:5,score:1};$.fn.StarsRating=function(options){if(!document.head.querySelector('#star-rating')){document.head.innerHTML+='<style id="star-rating" type="text/css">@{{main.css}}</style>'}
var options=$.extend({},defaults,options);return this.each(function(){new StarsRating(this,options);});}})(jQuery);